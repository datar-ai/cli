...
class UserLoginResponse(object):
    ...
    """
    def __init__(self, cluster_id=None, environment=None, user=None, ports=None, minio_access_key=None, minio_secret_key=None):
        """
    ...
    def user(self):
        """
        Gets the user of this UserLoginResponse.


        :return: The user of this UserLoginResponse.
        :rtype: str
        """
        return self._user
    ...
    def user(self, user):
        ...
        :param user: The user of this UserLoginResponse.
        :type: str
        """
